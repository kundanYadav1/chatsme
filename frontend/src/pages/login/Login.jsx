    ...
    <div className='flex flex-col items-center min-w-96 mx-auto'>
      <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter
       backdrop-blur-lg bg-opacity-0'>
        <h1 className="text-3xl font-semibold text-center text-grey-500 text-white">Login
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <button className="btn btn-block btn-sm mt-2 hover:bg-green-600 "
            disabled={loading}
            >
...
//       <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter
//        backdrop-blur-lg bg-opacity-0'>
//         <h1 className="text-3xl font-semibold text-center text-grey-500">Login
//           <span className=" text-blue-500">ChatsMe</span>
//         </h1>
//         <form >
//           <div>
